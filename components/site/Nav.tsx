...
export default function Nav({ siteName }: { siteName: string }) {
  ...
  return (
    <>
      ...
      >
        <div className="wrap flex items-center justify-between py-4.5">
          ...
          <div className="flex items-center gap-4">
            <Link href="/contact" className="nav-consultation-cta btn small hidden md:inline-flex">Book a Consultation</Link>
            <button
        ...
        {open && (
          <div className="mobile-nav-panel md:hidden flex flex-col gap-4 px-5 pb-6 pt-4 border-t border-line bg-white">
            {LINKS.map((l) => (
      ...
      <Link href="/contact" className="mobile-consultation-cta btn small" aria-label="Book a consultation">
        Book a Consultation
      </Link>
    </>
  );
